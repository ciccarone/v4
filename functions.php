...
function v4_scripts() {
	...
	wp_enqueue_script( 'v4-lightbox', get_template_directory_uri() . '/js/lightbox.js', array(), _S_VERSION, true );
	wp_enqueue_style( 'v4-lightbox-style', get_template_directory_uri() . '/css/lightbox.css', array(), _S_VERSION, true );
	...
	wp_enqueue_script( 'v4-custom', get_stylesheet_directory_uri() . '/js/v4.js', array('jquery', 'v4-lightbox'), _S_VERSION, true );
